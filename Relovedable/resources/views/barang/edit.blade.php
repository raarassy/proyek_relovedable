...
<div class="max-w-2xl mx-auto px-4 py-8">
    ...
    <form action="{{ url('/barang/update/' . $barang->id_barang) }}" method="POST" enctype="multipart/form-data"
        ...
        <div>
            <label class="block text-sm font-medium text-gray-600 mb-1">Tambah Foto <span class="text-gray-300">(opsional)</span></label>
        ...
        <div class="grid sm:grid-cols-3 gap-4">
            ...
            <div>
                ...
                <label class="flex items-center gap-2 mt-2.5 text-sm text-gray-600">
                    <input type="checkbox" name="metode_transaksi" value="1" {{ $barang->metode_transaksi ? 'checked' : '' }}
